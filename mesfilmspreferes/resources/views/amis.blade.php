...
.ami-card:hover { border-color: rgba(255,255,255,0.1); }
.ami-avatar {
    ...
    font-size: 18px; color: #bb3333; flex-shrink: 0;
}
.ami-name { font-size: 15px; font-weight: 700; color: var(--text); }
.ami-username { font-size: 12px; color: #38384e; margin-top: 1px; }
...
<div class="page-content">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:32px;flex-wrap:wrap;gap:12px;">
        <div>
            ...
            <p style="font-size:13px;color:#38384e;">Vos connexions</p>
        </div>
            ...
            <div class="modal-body">
                <form action="{{ route('amis.add') }}" method="POST">
                    ...
                    <div style="margin-bottom:14px;">
                        <label style="font-size:12px;font-weight:600;color:#40405a;text-transform:uppercase;letter-spacing:.06em;display:block;margin-bottom:8px;">Nom d'utilisateur ou email</label>
